...
//     ];
//     obs_positions.splice(1,18);

//     for(r=0;r<18;r++){
//       obs_positions.push(position[r]);
//     }
//     z-=60;
//   sp = z;
//   gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(obs_positions), gl.STATIC_DRAW);

//  const textureCoordBuffer = gl.createBuffer();
//   gl.bindBuffer(gl.ARRAY_BUFFER, textureCoordBuffer);
  
//   gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(obs_textureCoordinates),
//                 gl.DYNAMIC_DRAW);
...
// gl.bufferData(gl.ELEMENT_ARRAY_BUFFER,
//       new Uint16Array(obs_indices), gl.DYNAMIC_DRAW);
...
function draw_obstacle(gl, programInfo, buffers,  deltaTime,texture,rot) {
  // Clear the canvas before we start drawing on it.
 
  var projectionMatrix1,modelViewMatrix1;
